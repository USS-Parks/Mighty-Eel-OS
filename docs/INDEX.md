...
> - **Security Remediation lane (2026-07-05; AF-001..007, AQ-001/002, AS-001): IN-FLIGHT** — closing the 2026-07-05 repository audit at `6ffaaee` (Critical attenuation signer-oracle; High unauthenticated issuance, cross-tenant unseal, arbitrary cloud identity, false vault readiness; Medium revocation-not-consumed + public receipt ledger). Plan [`SECURITY-REMEDIATION-PSPR.md`](scans/SECURITY-REMEDIATION-PSPR.md); log [`SECURITY-REMEDIATION-DEVLOG.md`](sessions/SECURITY-REMEDIATION-DEVLOG.md); worktree branch `session/SEC-1`.
>
