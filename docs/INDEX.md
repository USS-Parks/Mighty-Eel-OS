...
> - **Lamprey Saddle WSF/AOG hardening (2026-07-15): AUTHORIZED / STS IN PROGRESS** — 29 confirmed root-cause families, 10 deferred families, and the remaining selected-file review are governed by the [canonical P-SPR](../../PLANNING/LAMPREY-SADDLE-WSF-AOG-SECURITY-HARDENING-PSPR.md). Execution log: [LAMPREY-SADDLE-HARDENING-DEVLOG.md](sessions/LAMPREY-SADDLE-HARDENING-DEVLOG.md); machine finding register: [LAMPREY-SADDLE-HARDENING-FINDINGS.json](scans/LAMPREY-SADDLE-HARDENING-FINDINGS.json). This lane supersedes conflicting current-status claims from earlier remediation documents without deleting their history.
...
> - **Security Remediation lane (2026-07-05; AF-001..007, AQ-001/002, AS-001): HISTORICAL / SUPERSEDED FOR CURRENT CLOSURE** — the `session/SEC-1` DEVLOG records its execution, despite the old PSPR's preserved unchecked roster. Current source evidence and remediation status are owned by the 2026-07-15 Lamprey Saddle lane above. Historical plan [`SECURITY-REMEDIATION-PSPR.md`](scans/SECURITY-REMEDIATION-PSPR.md); execution log [`SECURITY-REMEDIATION-DEVLOG.md`](sessions/SECURITY-REMEDIATION-DEVLOG.md).
>
