//! SHIP-17 (closes KNOWN-ISSUES Issue 13): regression coverage for the
...
//! SHIP-17, an operator could silently end up with the runtime bypass
...
fn prod_auth_101_deferred_without_runtime() {
    ...
    assert!(
        check.message.contains("SHIP-17"),
